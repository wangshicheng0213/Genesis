...
from Visualization import functionhelp
...
class DrawBioGridPPI:
    ...
    def draw_biogrid_ppi(self, id, f):
        ...
        dict_edges = {}
        try:
            all_ppi_point = all.get("PPI_Points")
            mutation_count_list = all.get("ppi_point_mutation_count")
            protein_brain_exp_flag_list = all.get("ppi_point_protein_brain_express")
            gene_brain_exp_flag_list = all.get("ppi_point_gene_brain_express")
