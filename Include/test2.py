...
edge = []
with open('edge-8.txt', 'r',encoding="utf-8-sig") as f:
    data = f.readlines()
    for line in data:
        # print line
...
nx.draw_networkx(G, pos=nx.random_layout(G), node_color=node_color, node_size=10, node_shape='o', edge_color=edge_color,
